...
class GGCNN(nn.Module):
    ...
    def forward(self, x):
        ...
        pos_output = F.interpolate(pos_output, size=(721, 721), mode='bilinear', align_corners=True)
        cos_output = F.interpolate(cos_output, size=(721, 721), mode='bilinear', align_corners=True)
        sin_output = F.interpolate(sin_output, size=(721, 721), mode='bilinear', align_corners=True)
        width_output = F.interpolate(width_output, size=(721, 721), mode='bilinear', align_corners=True)
