...
class GGCNN(nn.Module):
    ...
    def __init__(self, input_channels=1):
        ...
        self.angle_output = nn.Conv2d(filter_sizes[5], 1, kernel_size=2)
    ...
    def forward(self, x):
        ...
        return x, pos_output, angle_output, width_output
    ...
    def compute_loss(self, xc, yc):
        ...
        angle_loss = F.mse_loss(cos_pred, y_cos)
        width_loss = F.mse_loss(width_pred, y_width)

        loss =  p_loss + angle_loss + width_loss
